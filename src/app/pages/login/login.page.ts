...
constructor(private router: Router, private formBuilder: FormBuilder, private store: Store<AppState>,
  ...
  ngOnInit() {
    // Inisialisasi form menggunakan LoginPageForm
    this.form = new LoginPageForm(this.formBuilder).createForm();

    // Inisialisasi subscription ke state 'login'
    this.loginStateSubscription = this.store.select('login').subscribe((loginState: LoginState) => {
  ...
  ngOnDestroy() {
    // Unsubscribe dari store untuk mencegah memory leak
