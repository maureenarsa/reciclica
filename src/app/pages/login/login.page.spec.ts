...
import { AppState } from 'src/store/AppState';  // Pastikan impor ini benar dan jalurnya tepat
...
describe('LoginPage', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    router = TestBed.get(Router);  // Gunakan TestBed.inject
    store = TestBed.get(Store);  // Gunakan TestBed.inject
    toastController = TestBed.get(ToastController);  // Gunakan TestBed.inject
  ...
  it('given user is recovering password, when success, then hide loading and show success message', () => {
    spyOn(toastController, 'create').and.callThrough();  // Pastikan fungsi create dipanggil
...
it('given user is logging in, when success, then hide loading and send user to home page', () => {
  ...
  it('given user is logging in, when fail, then hide loading and show error message', () => {
    ...
    fixture.detectChanges();
    store.dispatch(login({email: "valid@email.com", password: "anyPassword"}));
    store.dispatch(loginFail({error: {message: 'erroe message'}}));
